    ...
    def process_images(self):
        ...
        if depth_value > 0:
            ...
            if self.odom_position:
                ...
                # sinthetha=point_y/dist
                # costhetha=cos(math.asin(sinthetha))
                ...
                # del_y=dist
                # del_x=point_x
                # object_x=dist*cos(self.orientation) + self.odom.position.x
                # object_y=dist*sin(self.orientation) +self.odom.position.y
